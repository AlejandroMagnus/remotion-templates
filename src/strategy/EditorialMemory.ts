 ...
 *
 * Responsabilidades:
 * - comparar contenido nuevo con producciones anteriores;
 * - detectar repetición editorial;
 * - distinguir continuidad temática de duplicación;
 * - permitir nuevos ángulos estratégicos;
 * - preparar el registro persistente de producciones.
 *
...
export type EditorialDecision = {
  ...
  noveltyLevel: EditorialNoveltyLevel;

  noveltyScore: number;

  highestSimilarity: number;

  closestContentCode: string | null;
