...
function paletteFor(spec: VideoSpec): Palette {
  if (spec.style.theme !== "default") {
    return palettes[spec.style.theme];
  }
...
function SemanticQaBackground() {
  return (
    <AbsoluteFill
      style={{
        background:
          "linear-gradient(180deg, #101714 0%, #17211d 55%, #101714 100%)",
      }}
    />
  );
}
  ...
  return (
    <div
      style={{
        ...
        background: surface,
        boxShadow:
          "0 28px 70px rgba(20, 40, 58, 0.10)",
        display: "flex",
        flexDirection:
          "column",
        alignItems:
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 18px 52px rgba(20, 40, 58, 0.07)",
                }}
              >
                <div
                  style={{
      ...
      <div
        style={{
          ...
          background:
            palette.surface,
          boxShadow:
            "0 32px 90px rgba(20, 40, 58, 0.10)",
          opacity:
            progress,
          transform:
            `translateY(${interpolate(
      ...
      <div
        style={{
          ...
          background:
            palette.surface,
          boxShadow:
            "0 28px 80px rgba(20, 40, 58, 0.14)",
        }}
      >
        {src ? (
          <OffthreadVideo
